# MAX78000 Keyword Spotting Demo v.3.2 (`w90`)

This folder contains the width-reduced `w90` variant of the original `kws20_demo`.
Use it as a separate project for build/flash/measurement so the baseline demo stays untouched.
