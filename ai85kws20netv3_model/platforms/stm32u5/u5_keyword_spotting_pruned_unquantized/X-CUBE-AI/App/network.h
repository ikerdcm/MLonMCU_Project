...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "kws20_v3_w90_conv2d_float_for_stm32u5"
...
#define AI_NETWORK_OUT_1_CHANNEL     (21)
#define AI_NETWORK_OUT_1_SIZE        (21)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (84)
